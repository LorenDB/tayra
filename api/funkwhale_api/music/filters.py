...
class ChannelFilterSet(filters.FilterSet):
    ...
    def filter_channel(self, queryset, name, value):
        ...
        actor = utils.get_user_from_request(self.request)
...
class ArtistFilter(
    ...
    scope = common_filters.ActorScopeFilter(
        user_field="artist_credit__tracks__uploads__library__owner",
        distinct=True,
    ...
    class Meta:
        ...
        channel_filter_field = "track__artist_credit__artist"
...
class AlbumFilter(
    ...
    content_category = django_filters.CharFilter(method="filter_content_category")
    tag = TAG_FILTER
    ...
    scope = common_filters.ActorScopeFilter(
        user_field="tracks__uploads__library__owner",
        distinct=True,
    ...
    def filter_content_category(self, queryset, name, value):
        exists = models.ArtistCredit.objects.filter(
            albums=OuterRef("pk"),
            artist__content_category=value,
        )
        return queryset.annotate(has_category=Exists(exists)).filter(has_category=True)
