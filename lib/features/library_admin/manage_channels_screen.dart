...
class _ManageChannelsScreenState extends ConsumerState<ManageChannelsScreen> {
  ...
  final List<ManageChannel> _items = [];
  int _page = 1;
  int _count = 0;
  bool _loading = true;
  ...
  Future<void> _load({bool reset = false}) async {
    ...
    try {
      ...
      final res = await api.getManageChannels(
        page: 1,
        pageSize: 25,
        ...
        child: ListView(
          ...
          children: const [
            ...
            EmptyState(
              ...
              title: 'No channels',
              subtitle: 'No channels match your search',
            ),
          ],
        ),
      );
    ...
    return AppRefreshIndicator(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final channel = _items[index];
          return _ChannelTile(
            channel: channel,
            onTap:
                () => context.push('/manage/library/channels/${channel.uuid}'),
          );
        },
      ),
    );
...
class _ChannelTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final subtitle = [
      ...
      if (channel.ownerLabel != '—') channel.ownerLabel,
      if (channel.tracksCount != null) '${channel.tracksCount} tracks',
      if (channel.domain != null) channel.domain!,
    ].join(' · ');
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        channel.name.isEmpty ? channel.uuid : channel.name,
