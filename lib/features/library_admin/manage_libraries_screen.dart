...
class _ManageLibrariesScreenState extends ConsumerState<ManageLibrariesScreen> {
  ...
  final List<ManageLibrary> _items = [];
  int _page = 1;
  int _count = 0;
  bool _loading = true;
  ...
  Future<void> _load({bool reset = false}) async {
    ...
    try {
      ...
      final res = await api.getManageLibraries(
        page: 1,
        pageSize: 25,
        ...
        child: ListView(
          ...
          children: const [
            ...
            EmptyState(
              ...
              title: 'No libraries',
              subtitle: 'No libraries match your search',
            ),
          ],
        ),
      );
    ...
    return AppRefreshIndicator(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final lib = _items[index];
          return _LibraryTile(
            library: lib,
            onTap: () => context.push('/manage/library/libraries/${lib.uuid}'),
          );
        },
      ),
    );
...
class _LibraryTile extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final owner = library.actor?.displayLabel;
    final subtitle = [
      library.privacyLevelLabel,
      if (owner != null) owner,
      '${library.uploadsCount} uploads',
      if (library.domain != null) library.domain!,
    ].join(' · ');
        ...
        child: InkWell(
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                Icon(
                  library.isLocal ? Icons.folder_rounded : Icons.public_rounded,
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        library.name.isEmpty ? library.uuid : library.name,
